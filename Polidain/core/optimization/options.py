...
from core.optimization import OptimizeConfig, BoundsConfig, DifferentialEvolutionConfig
...
def calculate_cam_optimization(cam_optimization_options: CamOptimizationOptions):
    """
    Запускает процесс оптимизации кулачкового механизма под заданный профиль.
    """
